...
const DonationTypeView = ({ id, onBack, onEdit }) => {
    ...
    return (
      <div style={{ padding: 32 }}>
        <Alert
          ...
          description={error?.message || "Donation Type not found"}
          type="error"
          showIcon
  ...
  const renderValue = (field, value) => {
    ...
    if (field.name === "default_amount") {
      return <span style={{ fontSize: 13, fontWeight: 700, color: "#16A34A" }}>₹{Number(value).toLocaleString("en-IN")}</span>;
    }
  ...
  return (
    <div className="temple-donation-app donation-type-view-root" style={{ background: C.bg, minHeight: "100vh", padding: "32px 24px 120px 24px" }}>
        ...
        <Row gutter={[24, 24]}>
          ...
          <Col xs={24} lg={16}>
            <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
              ...
              {/* Field details */}
              <SectionCard title="Donation Type Details">
                <Row gutter={[16, 16]}>
